...
<body class="animsition">
	...
	<?php
      ...
      $sqll = "SELECT * FROM cad_produto WHERE id = '".$_GET['idp']."'";
	...
	<div class='container bgwhite p-t-35 p-b-80'>
		<div class='flex-w flex-sb'>
			...
			<div class='w-size14 p-t-30 respon5'>
				...
				<div class='p-b-45'>
					<span class='s-text8 m-r-35'>SKU: ".$dados['id']."</span>
					<span class='s-text8'>Categories: ".$dados['categoria']." </span>
				</div>
						...
						<div class='block2'>
							<div class='block2-img wrap-pic-w of-hidden pos-relative block2-labelnew'>
								...
								<div class='block2-overlay trans-0-4'>
									<a href='#' class='lock2-btn-addwishlist hov-pointer trans-0-4'>
